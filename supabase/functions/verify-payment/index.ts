...
serve(async (req) => {
  ...
  try {
    ...
    // NOTE: Booking and project creation is handled by stripe-webhook (checkout.session.completed)
    // This function only verifies payment and creates the payment record as a fallback
    // Do NOT create bookings/projects here to avoid duplicates
