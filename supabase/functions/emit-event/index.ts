...
const EVENT_CONFIG: Record<string, {
  ...
  PROJECT_CREATED: {
    ...
    priority: "normal",
    role: "all",
    getLink: (m) => m.is_admin ? `/admin/projects/${m.entity_id}` : `/client/projects/${m.entity_id}`,
  },
  PROJECT_STATUS_CHANGED: {
    ...
    priority: "normal",
    role: "client",
    getLink: (m) => `/client/projects/${m.entity_id}`,
  },
  PROJECT_COMPLETED: {
  ...
  TICKET_REPLIED: {
    ...
    priority: "normal",
    role: "all",
    getLink: (m) => m.is_admin ? `/admin/tickets?id=${m.entity_id}` : `/client/tickets/${m.entity_id}`,
  },
