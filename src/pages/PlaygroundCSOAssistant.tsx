...
import { Loader2, ArrowLeft, Briefcase, Send } from "lucide-react";
...
const INITIAL_MESSAGE: ChatMessage = {
  role: "assistant",
  content:
    "Hi 👋 I'm your CSO Assistant. Ask me anything about sales, pipelines, or closing strategies.",
};
...
const PlaygroundCSOAssistant = () => {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (!aiResponse || aiResponse.trim().length === 0) throw new Error("Empty response");
      ...
      setMessages((prev) => [
        ...prev,
        {
          role: "assistant",
          content:
            "Sales assistant is temporarily unavailable. Please try again.",
        },
      ]);
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <SEO
        title="CSO Assistant – AI Sales Strategy Chat | Exavo AI"
        description="Chat with an AI-powered sales strategist to improve pipelines, closing strategies, and sales performance."
      />
      <Navigation />
      ...
      <main className="flex-1 container mx-auto px-4 py-6 max-w-3xl flex flex-col min-h-0">
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold">CSO Assistant</h1>
              <p className="text-sm text-muted-foreground">
                AI-powered sales strategies &amp; pipeline insights
              </p>
            </div>
          </div>
            ...
            <div className="border-t border-border/50 p-3 bg-background/80 backdrop-blur-sm">
              <div className="flex gap-2 items-center">
                <Input
                  ...
                  placeholder="Ask about sales strategies, pipelines, closing techniques..."
                  disabled={isLoading}
                  className="flex-1"
                  maxLength={1000}
                />
...
export default PlaygroundCSOAssistant;
