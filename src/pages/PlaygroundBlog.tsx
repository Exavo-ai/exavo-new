...
import { ArrowLeft, Loader2, PenTool, AlertCircle } from "lucide-react";
...
const PlaygroundBlog = () => {
  ...
  const handleGenerate = useCallback(async () => {
    if (loading || !title.trim() || remaining === 0) return;
  ...
  }, [title, loading, remaining]);

  const isDisabled = !isAuthenticated || loading || !title.trim() || remaining === 0;

  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="AI Blog Generator – Free AI Content | Exavo AI"
        description="Generate up to 3 AI-powered blog posts per day. Free for registered users."
      />
      <Navigation />
            ...
            <Card className="border-border/50">
              <CardHeader>
                ...
                <p className="text-muted-foreground text-sm mt-2">
                  Generate AI-powered blog posts from a title. Up to 3 free generations per day.
                </p>
              </CardHeader>
