...
const translations = {
  en: {
    ...
    // About Page
    'about.hero.badge': 'About Exavo AI',
    'about.hero.title': 'Empowering Businesses with Intelligent Automation',
    'about.hero.subtitle': 'A global AI technology company delivering enterprise-grade automation, intelligent workflows, and data-driven insights that transform business operations.',
    'about.stats.clients': 'Business Clients',
    'about.stats.countries': 'Countries',
    'about.stats.team': 'AI-Driven Professional Team',
    'about.who.badge': 'Who We Are',
    'about.who.title': 'Global AI Innovation Partner',
    'about.who.para1': 'Exavo AI is a global technology company specializing in artificial intelligence, automation, and enterprise solutions. Our team of AI engineers, solution architects, and automation experts work across continents to deliver cutting-edge solutions.',
    'about.who.para2': 'We combine deep technical expertise with business acumen to create scalable, secure, and innovative AI systems that drive measurable results. From intelligent chatbots to complex workflow automation, we engineer solutions that matter.',
    'about.who.para3': 'Our commitment to innovation, security, and excellence has made us a trusted partner for businesses seeking to leverage AI for competitive advantage.',
    'about.who.tag1': 'AI Engineering',
    'about.who.tag2': 'Enterprise Solutions',
    'about.who.tag3': 'Global Team',
    'about.who.imageAlt': 'Professional team collaboration',
    'about.values.title': 'Our Core Values',
    'about.values.subtitle': 'The principles that guide our work and relationships',
    'about.values.innovation.title': 'Innovation',
    'about.values.innovation.desc': 'Pioneering new approaches to AI and automation',
    'about.values.security.title': 'Security',
    'about.values.security.desc': 'Enterprise-grade protection for your data',
    'about.values.efficiency.title': 'Efficiency',
    'about.values.efficiency.desc': 'Streamlined solutions that deliver results',
    'about.values.precision.title': 'Precision',
    'about.values.precision.desc': 'Accurate, reliable AI systems you can trust',
    'about.global.title': 'Global Network',
    'about.global.subtitle': 'Operating across continents with a distributed team of experts',
    'about.global.presence': 'Worldwide Presence',
    'about.global.description': 'Our AI engineers, automation specialists, and solution architects collaborate across time zones to deliver 24/7 support and continuous innovation.',
    'about.contact.title': 'Get In Touch',
    'about.contact.subtitle': 'Connect with our team for inquiries, support, or partnership opportunities',
    'about.contact.sales.title': 'Sales & Partnerships',
    'about.contact.sales.desc': 'Explore enterprise solutions and partnership opportunities',
    'about.contact.support.title': 'Technical Support',
    'about.contact.support.desc': 'Get help with your implementation and services',
    'about.contact.general.title': 'General Inquiries',
    'about.contact.general.desc': 'Questions about Exavo AI and our services',
    'about.contact.cta': 'Contact Us Today',
  },
  ar: {
    // Navigation
    'nav.home': 'الرئيسية',
